...
function () {
  ...
  User.prototype.set = function (update) {
    var updatedObject = Object.assign(this.data, update);
    console.log(updatedObject); // for(let objData in update){
  ...
  User.prototype.fetch = function () {
    ...
    axios_1.default.get("http://localhost:3000/users/" + this.get('id')).then(function (reponse) {
  ...
  User.prototype.save = function () {
    ...
    if (id) {
      ...
      axios_1.default.post('http://localhost:3000/users', this.data); //save
    }
  };
...
exports.User = User;
},{"axios":"node_modules/axios/index.js","./Eventing":"models/Eventing.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
